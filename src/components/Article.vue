	...
	<div id="article">
		...
		<div class="content">
		    ...
		    <div class="cont">
		        ...
		        <div id="text-box" class="text-box" v-html="articleData.content"></div>
		    </div>
		</div>
		<div class="foot-btn">
			<ul>
...
<style scoped>
	...
	.nav{width:304px; position:fixed;top:0;left:0; background:#fff; border-bottom:1px solid #e8eaec; z-index:99;}
	...
	.content .header{ padding:0.39rem 0.28rem 0.15rem 0.28rem; height:auto; background: none;overflow: hidden;}
	...
	.cont .time{height:0.24rem; line-height:0.24rem; margin:0.26rem 0; font-size: 12px;}
	.time p{ text-align: left;position:relative;}
	.time span{width:0.33rem;height:0.32rem; position:absolute; top:-0.02rem;right:2.7rem;}
