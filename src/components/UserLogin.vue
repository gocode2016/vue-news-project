...
<style scoped>
	...
	.content h1{width:2.18rem;height:1.35rem; background:url(http://img.sc115.com/uploads/sc/jpgs/1505/apic11595_sc115.com.jpg) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
	...
	.content .login-box .lsolid{width:1.96rem;height:0.18rem; border-bottom:1px solid #4c4f50; position:absolute;top:-50px;left:0.1rem;}
	.content .login-box .rsolid{width:1.96rem;height:0.18rem; border-bottom:1px solid #4c4f50; position:absolute;top:-50px;right:0.1rem;}
	.content ul{width:5.78rem;height:2.5rem; border:1px solid #e5e7e8; background:#fff; margin:0 auto; margin-top:0.4rem;padding: 0;}
	.content ul li{height:0.95rem; position:relative;}
	.content ul li.lifirst{border-bottom:1px solid #e5e7e8;margin-bottom: 6px;background:#f2f4f5;}
	.content ul li input{ padding-left:1.24rem;width:4.54rem;height:100%; font-size:0.4rem;}
	.content ul li span{width:1.23rem;height:0.49rem; position:absolute;top:0.7rem;left:0; border-right:1px solid #676868; color:#676868; font-size:0.25rem; line-height:0.49rem; text-align:center;}
	.content .footbox{width:4.65rem;height:0.65rem;margin:0 auto; }
	.content .login-btn{width:4.65rem;height:0.65rem; background:#4c4f50; color:#fff; text-align:center; line-height:0.65rem; border-radius:8px; display:block; margin-top:0.3rem; font-size:0.28rem;}
